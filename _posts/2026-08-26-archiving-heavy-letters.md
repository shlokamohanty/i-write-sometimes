...
So, I’ve realised. I struggle to emote. So, when I started writing for the first time. I realised, oh wait, I finally have a tool to express myself. Under the guise of writing for others, I began writing for myself: metaphors for my inner thoughts and desires, and processing my feelings of hurt that I held onto from the past. So in writing, I learned a lot about myself. So, again, was the writing for others, or for myself? I’m starting to see the self-indulgence here, and it’s okay, though. There’s more honesty in making it for yourself than for others, and it takes the weight away from reception. Reception is not in your control, and reception demands control, I think.
...
But there is more to saying that it is meant for someone else. Letters, by nature, are structured for someone else, but I think there is more to this; by that I mean the address. Structurally, letters can be addressed to someone, which creates a boundary and distance that I think is helpful for processing. But an audience, real vs imagined, changes it slightly. ~~A real audience would mean the reception shapes it too.~~ The conundrum is that both the real and the imagined have a shape of reception. But the shapes differ. The imagined audience is thus then just for myself, as a means of processing tool. The address makes the processing possible in nuance, because I imagine a receiver.

Making things for myself, but it could be shaped as if it were for someone else. But it is still for myself.