...
### Drawing as a method of research in studio art
- captures movements
- the embodiment of tensions
- relationships between people

### Bodies
- how they move
- convey messages
- how they are policed by different institutions and socially dictated rules

gesture drawings are a powerful heuristic to build knowledge.

heavy lines capture movement shifts and body discomfort

- gesture drawings are subjective
- gesture drawings allow artists to pass through the subject
- gesture drawings capture how bodies speak independently of the subject's conscious word choice

## Anthropological content analytic protocol
https://www.jstor.org/stable/20715817

### Coding Features
- settings
- actors - who is depicted?
- activities represented
- behavioural constraints 
        -  limitations or rules depicted in drawings
- power relations
        -  dynamics
- is the drawing symbolic or representational
- emotional tone

### National Integration
- local, national and cross cultural imagery

### Interrater agreement
- level of consistency among different evaluators
